...
import { MessageSquare, MoreHorizontal, Layout, Image as ImageIcon } from "lucide-react";
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                                <DropdownMenuItem onClick={() => setSettingsTab("banner")}>
                                    <Layout className="w-4 h-4 mr-2" />
                                    Hoşgeldin Panosu
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => setSettingsTab("cover")}>
